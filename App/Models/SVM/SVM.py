...
from App.ProcessRawData import process_images, process_image


def train_model(train_data, kernel, degree):
    '''
...
model = train_model(train_set, 'rbf',2)

test_set = np.load("../Data/ProcessedRawData/TestSet/PvNormalDataNormalised.npy")
